...
- **Multi-tenancy**: tenant derives from the trusted gateway auth-context (`X-Auth-Tenant`, `l64-auth-context-spring-boot-starter`); `RequestTenantProvider` supplies it (dev fallback: `labs64.tenant.default`).
