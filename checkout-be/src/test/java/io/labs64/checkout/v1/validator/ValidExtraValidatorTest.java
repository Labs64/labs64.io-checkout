...
class ValidExtraValidatorTest {
    ...
    private ValidExtraValidator newValidator(final int maxEntries, final int maxKeyLength, final String keyPattern,
        ...
        final ValidExtraValidator v = new ValidExtraValidator();
        v.initialize(ann);
        return v;
    }
    ...
    void shouldPassWhenTargetIsNull() {
        final ValidExtraValidator validator = newValidator(10, 50, "", true, true, true, 255);
    ...
    void shouldFailWhenTooManyEntries() {
        ...
        final ValidExtraValidator validator = newValidator(1, 50, "", true, true, true, 255);
    ...
    void shouldFailWhenKeyTooLong() {
        ...
        final ValidExtraValidator validator = newValidator(10, 3, "", true, true, true, 255);
    ...
    void shouldFailWhenKeyDoesNotMatchPattern() {
        ...
        final ValidExtraValidator validator = newValidator(10, 50, "^[a-z_]+$", true, true, true, 255);
    ...
    void shouldFailWhenStringValueTooLong() {
        ...
        final ValidExtraValidator validator = newValidator(10, 50, "", true, false, false, 3);
    ...
    void shouldFailWhenNumberIsNaNOrInfinity() {
        ...
        final ValidExtraValidator validator = newValidator(10, 50, "", false, true, false, 255);
    ...
    void shouldPassWhenAllowedTypesAndLengthsOk() {
        final ValidExtraValidator validator = newValidator(10, 50, "", true, true, true, 10);
        final Map<String, Object> extra = new LinkedHashMap<>();
        extra.put("s", "ok");
        extra.put("n", 42);
    ...
    void shouldFailWhenValueTypeNotAllowed() {
        ...
        final ValidExtraValidator validator = newValidator(10, 50, "", true, false, false, 10);
